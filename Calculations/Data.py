...
enemies = np.tile(np.array([-100, -100, 0, 0, 0, 0, 0, 0, 1, 0, 0], dtype=np.float_), (MAX_ENEMIES, 1))
bullets = np.tile(np.array([-200, -200, 0, 0, 0, 0, 0, 0, 1, 0, 1, 0], dtype=np.float_), (MAX_BULLETS, 1))
...
player = np.array([[1000, 1000, PLAYER_HALF_SIZE_X, PLAYER_HALF_SIZE_Y, PLAYER_MAX_HP, 0, 0, 0, PLAYER_MAX_VELOCITY,
                    ...
                    PLAYER_BULLET_VELOCITY, PLAYER_DAMAGE_DELAY, 0, 0]], dtype=np.float_)
field = np.array([0, 0, MOVE_SCREEN_RECT_X, MOVE_SCREEN_RECT_X, 0, 0, FIELD_WIDTH, FIELD_HEIGHT, WIDTH, HEIGHT],
                 dtype=np.float_)
