...
SIZE_PLAYER_LEVEL_INTERFACE_X = WIDTH - 20
SIZE_PLAYER_LEVEL_INTERFACE_Y = 20

SIZE_WAVE_INTERFACE_X: int = 20
SIZE_WAVE_INTERFACE_Y: int = HEIGHT // 2

COORD_HP_INTERFACE_X: int = 10
COORD_HP_INTERFACE_Y: int = 50

COORD_WAVE_INTERFACE_X: int = WIDTH - 10 - SIZE_WAVE_INTERFACE_X
COORD_WAVE_INTERFACE_Y: int = 50

COORD_PLAYER_LEVEL_INTERFACE_X: int = 10
COORD_PLAYER_LEVEL_INTERFACE_Y: int = 10

COORD_CHARACTERISTICS_INTERFACE_X: int = 40
COORD_CHARACTERISTICS_INTERFACE_Y: int = 50
