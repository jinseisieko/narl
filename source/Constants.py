...
SIZE_PLAYER_LEVEL_INTERFACE_X = 20 - 6
SIZE_PLAYER_LEVEL_INTERFACE_Y = HEIGHT // 2 - 6

SIZE_WAVE_INTERFACE_X: int = 20 - 6
SIZE_WAVE_INTERFACE_Y: int = HEIGHT // 2 - 6

COORD_HP_INTERFACE_X: int = 10
COORD_HP_INTERFACE_Y: int = 10

COORD_WAVE_INTERFACE_X: int = WIDTH - 10 - SIZE_WAVE_INTERFACE_X - 3
COORD_WAVE_INTERFACE_Y: int = 10

COORD_PLAYER_LEVEL_INTERFACE_X: int = COORD_WAVE_INTERFACE_X - 15 - SIZE_PLAYER_LEVEL_INTERFACE_X
