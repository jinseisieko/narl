...
#         super().__init__()
#         self.image_old = pygame.Surface((self.size, self.size))
#         # self.image_old.fill([random.randint(5, 200) for _ in range(3)])
#         # pygame.draw.rect(self.image_old, 0, (self.size // 5, self.size // 3, self.size // 7, self.size // 5), width=4)
...
#
#         self.image_old.fill((255, int(255 / self.mhp * self.hp), int(255 / self.mhp * self.hp)))
#         pygame.draw.rect(self.image_old, 0, self.outlines_rect, width=4)
#         pygame.draw.rect(self.image_old, 0, self.left_eye_rect)
#         pygame.draw.rect(self.image_old, 0, self.right_eye_rect)
#
#         self.dx: float = 0.
#         self.dy: float = 0.
#
